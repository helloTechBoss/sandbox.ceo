...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  return {
    title: isEn ? 'Contact Us | Sandbox Group' : '聯絡我們 | Sandbox Group',
    description: isEn ? 'Get immediate expert advice from our compliance advisory team.' : '即時獲取我們合規顧問團隊的專業建議。',
  };
}
    ...
    <>
      ...
      <main>
        ...
        <section style={{ padding: '80px 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start' }}>
            {/* Contact Info */}
            <div>
              <h2 style={{ fontFamily: "'Noto Sans TC',sans-serif", fontWeight: 700, fontSize: '1.3rem', color: '#0F2557', marginBottom: 6 }}>
                {isEn ? 'Hong Kong Office Contact' : '香港辦公室聯絡'}
              </h2>
              ...
              <div style={{ background: '#EF4444', padding: 28, marginBottom: 24 }}>
                <h3 style={{ fontFamily: "'Noto Sans TC',sans-serif", fontWeight: 700, color: '#fff', fontSize: '.95rem', marginBottom: 16 }}>
                  {isEn ? 'Get Immediate Expert Response' : '即時專家回覆'}
                </h3>
                ...
                <a href={waHref} target="_blank" rel="noopener noreferrer" style={{
                  ...
                  {isEn ? 'WhatsApp Us Now' : '立即 WhatsApp'}
                </a>
              </div>
